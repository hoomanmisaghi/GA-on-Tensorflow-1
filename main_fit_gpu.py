...
in this file fitness function is called from GA.py file
fitness function should be on gpu
...
for i in range(generation):
    ...
    best_val=[]
    for param in vals:
        best_val.append(param[THE_WINNER, :, :])

    if i==0:
        total_best=Best
        total_best_val=best_val
...
pickle.dump(total_best_val,open('net_data\\best_weights.p','wb'))
